...
func openProgram(_ computer: Computer) throws {
    ...
    panel.beginSheetModal(for: window, completionHandler: { (result) in
        if result == NSApplication.ModalResponse.OK {
            ...
            computer.program = ProgramCoder.decodeProgram(data: dataString) ?? Program()
            computer.commandCounter.value = computer.program.start

            print("Program assigned", computer.program.count)

...
class MicroCommandStatus {
    ...
    var externalDevices: ExternalDevices

    var microCommand: MicroCommand
    var microCommandRegister: UInt16
    var microCommandCounter: Register<UInt16>
    var buffer: UInt32
    ...
    init(_ computer: Computer, _ microCommand: MicroCommand) {
        ...
        self.microCommandCounter = computer.microCommandManager.microCommandCounter
